...
<div class="app">
  ...
  <div class="info">
    ...
    <ul>
      <li>
        <strong>presenceAffectsLayout=true</strong> (default): Items shift up immediately
        as an item starts exiting. The layout animation happens simultaneously with
        the exit animation.
      </li>
      <li>
        <strong>presenceAffectsLayout=false</strong>: Items wait to shift up
        until the exiting item's animation completes. The layout is preserved
        during the exit animation.
      </li>
    </ul>
    <p class="tip">
      💡 <strong>Try this:</strong> Toggle the checkbox and remove items to see the
