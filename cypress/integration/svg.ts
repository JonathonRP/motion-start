	...
	it('Correctly applies transforms', () => {
		cy.visit('?test=svg')
			...
			.should(($rotate: any) => {
				...
				const { top, left, right, bottom } = rotate.getBoundingClientRect();
			...
			.should(($scale: any) => {
				...
				const { top, left, right, bottom } = scale.getBoundingClientRect();
			...
			.should(($translate: any) => {
				...
				const { top, left, right, bottom } = translate.getBoundingClientRect();
