...
import { SVGVisualElement } from '../../render/svg/SVGVisualElement.svelte';
import { HTMLVisualElement } from '../../render/html/HTMLVisualElement.svelte';
import { visualElementStore } from '../../render/store.svelte';
import { ObjectVisualElement } from '../../render/object/ObjectVisualElement.svelte';
