 ...
 */
export function applyConstraints(point: number, { min, max }: Partial<Axis>, elastic?: Axis): number {
 ...
 */
export function calcViewportAxisConstraints(layoutAxis: Axis, constraintsAxis: Axis) {
 ...
 */
export function calcProgressWithinConstraints(layoutBox: Box, constraintsBox: Box): Point {
	return {
 ...
 */
export function calcPositionFromProgress(axis: Axis, constraints: Axis, progress: number): Axis {
 ...
 */
export function rebaseAxisConstraints(layout: Axis, constraints: Partial<Axis>): Partial<Axis> {
 ...
 */
export function resolveDragElastic(dragElastic: DragElastic = defaultElastic): Box {
