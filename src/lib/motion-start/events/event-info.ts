...
var wrapHandler = (handler: EventListenerWithPointInfo, shouldFilterPrimaryPointer?: boolean): EventListener => {
	if (shouldFilterPrimaryPointer === void 0) {
		shouldFilterPrimaryPointer = false;
	}
	var listener = (event: PointerEvent) => handler(event, extractEventInfo(event));
