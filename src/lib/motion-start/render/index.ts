...
import { MotionValue, motionValue } from '../value/index.js';
...
var visualElement = function <Instance = any, MutableState = any, Options extends {} = {}>({ treeType, build, getBaseTarget, makeTargetAnimatable, measureViewportBox, render: renderInstance, readValueFromInstance, resetTransform, restoreTransform, removeValueFromRenderState, sortNodePosition, scrapeMotionValuesFromProps, }: VisualElementConfig<Instance, MutableState, Options>) {
    return function ({ parent, props, presenceId, blockInitialAnimation, visualState, }: VisualElementOptions<Instance, any>, options?: Options) {
         ...
         */
        var projectionParent: boolean | undefined;
        /**
        ...
        var unsubscribeFromLeadVisualElement: Function | null | undefined;
        /**
         ...
         *
         */
        var crossfader: { isActive: () => any; getCrossfadeState: (arg0: VisualElement<Instance, any>) => any; };
        /**
         ...
         */
        var projectionTargetProgress: { x: MotionValue<number>; y: MotionValue<number>; };
        /**
         ...
         */
        var removeFromVariantTree: (() => void) | null | undefined;
        /**
         *
         */
        function render() {
        ...
        function triggerBuild() {
            ...
            build(element, renderState, valuesToRender, leadProjection, layoutState, options as Options, props);
        }
        function update() {
         ...
         *
         */
        function bindToMotionValue(key: string, value: { onChange: (arg0: (latestValue: any) => void) => any; onRenderRequest: (arg0: () => void) => any; }) {
        ...
        var element: VisualElement<Instance, any> = __assign(__assign({
             ...
             */
            isMounted: function () { return Boolean(instance); }, mount: function (newInstance: Instance | null) {
            ...
            sortNodePosition: function (other: { treeType: string | undefined; getInstance: () => Instance; }) {
                ...
                if (!sortNodePosition || treeType !== other.treeType)
                    return 0;
                return sortNodePosition(element.getInstance() as Instance, other.getInstance());
            },
            /**
             ...
             */
            getStaticValue: function (key: string | number) { return latestValues[key]; }, setStaticValue: function (key: string | number, value: string | number) { return (latestValues[key] = value); },
            /**
             ...
             */
            forEachValue: function (callback: (value: any, key: any, map: Map<any, any>) => void) { return values.forEach(callback); },
            /**
             * If we're trying to animate to a previously unencountered value,
             * we need to check for it in our state and as a last resort read it
             * directly from the instance (which might have performance implications).
             */
            readValue: function (key: string) { var _a; return (_a = latestValues[key]) !== null && _a !== void 0 ? _a : readValueFromInstance(instance as Instance, key, options); },
            /**
             ...
             */
            getVariant: function (name: string | number) { var _a; return (_a = props.variants) === null || _a === void 0 ? void 0 : _a[name]; },
            /**
            ...
            }, getLayoutState: function () { return layoutState; }, setCrossfader: function (newCrossfader: any) {
             ...
             */
            startLayoutAnimation: function (axis: AxisKey, transition: Transition | undefined, isRelative: boolean | undefined) {
            ...
            measureViewportBox: function (withTransform: boolean | undefined) {
                ...
                var viewportBox = measureViewportBox(instance as Instance, options);
                if (!withTransform)
             ...
             */
            resetTransform: function () { return resetTransform(element, instance as Instance, props); }, restoreTransform: function () { return restoreTransform(instance as Instance, renderState); }, updateLayoutProjection: updateLayoutProjection,
             ...
             *
             */
            pointTo: function (newLead: { projection: TargetProjection; getLatestValues: () => ResolvedValues; onSetAxisTarget: (arg0: () => void) => Function; onLayoutAnimationComplete: (arg0: () => void) => Function; }) {
...
function fireUpdateLayoutProjection(child: { updateLayoutProjection: () => void; }) {
