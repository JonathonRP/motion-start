...
<script lang="ts">
  ...
  import { UseRender } from "../../dom/use-render.js";
  ...
  import type { MotionProps } from "../../../motion/index.js";
  import { useMotionRef } from "../../../motion/utils/use-motion-ref.js";
  import { UseVisualElement } from "../../../motion/utils/use-visual-element";
