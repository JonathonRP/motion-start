 ...
 * @public
 */
const motion = /*@__PURE__*/ createMotionProxy(domMax);
...
function createDomMotionComponent<T extends keyof DOMMotionComponents>(key: T): DOMMotionComponents[T] {
	...
	// @ts-expect-error
	return createRenderMotionComponent(config);
}
