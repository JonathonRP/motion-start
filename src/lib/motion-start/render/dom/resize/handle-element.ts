...
function getElementSize(target: Element, borderBoxSize?: ReadonlyArray<ResizeObserverSize>) {
	if (borderBoxSize) {
...
function notifyTarget({ target, contentRect, borderBoxSize }: ResizeObserverEntry) {
...
export function resizeElement(target: ElementOrSelector, handler: ResizeHandler<Element>) {
